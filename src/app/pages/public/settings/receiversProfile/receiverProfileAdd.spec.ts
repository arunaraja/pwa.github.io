...
import { receiversprofileaddPage } from './receiversProfileAdd.page';
...
describe('receiversprofileaddPage', () => {
  let comp: receiversprofileaddPage;
  let fixture: ComponentFixture<receiversprofileaddPage>;
  let de: DebugElement;
  let el: HTMLElement;
...
//   comp.openNavBar = true ;
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      fixture = TestBed.createComponent(receiversprofileaddPage);
  ...
  it('should create the app', () => {
    const fixture = TestBed.createComponent(receiversprofileaddPage);
    const app = fixture.componentInstance;
    expect(app).toBeTruthy();
  });

  it(`should have as title 'Add Receiver's Profile'`, () => {
    const fixture = TestBed.createComponent(receiversprofileaddPage);
    const app = fixture.componentInstance;
    expect(app.title).toEqual("Add Receiver's Profile");
  });

  it("should check label name to be Add Receiver's Profile", () => {
    let labelName = fixture.debugElement.query(By.css("#add-receiver-title"));
    expect(labelName.nativeElement.textContent.trim()).toBe("Add Receiver's Profile");
  });
  ...
  it('should check button name to be Save', () => {
    let labelName = fixture.debugElement.query(By.css("#save-receiver-profile"));
