...
//   comp.openNavBar = true ;
  ...
  it(`should have as title 'Edit Profile'`, () => {
    const fixture = TestBed.createComponent(profileeditPage);
    const app = fixture.componentInstance;
    expect(app.title).toEqual('Edit Profile');
  });
  ...
  it('should check label name to be Edit Profile', () => {
    let labelName = fixture.debugElement.query(By.css("#edit-pro-title"));
    expect(labelName.nativeElement.textContent.trim()).toBe('Edit Profile');
  });
  ...
  it('should check button name to be Update', () => {
    let labelName = fixture.debugElement.query(By.css("#profile-update"));
